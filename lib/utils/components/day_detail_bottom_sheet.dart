              ...
              child: Row(
                ...
                children: [
                  Column(
                    ...
                    children: [
                      Text(
                        "${DateFormat('d MMM').format(date)}${getValueForDateInMap(date, PeriodSession().cycleNumbers)?["cycleDay"] == -1
                            ? ""
                            : " \u2022 Cycle Day ${getValueForDateInMap(date, PeriodSession().cycleNumbers)?["cycleDay"]}" }",
                        style: TextStyle(
