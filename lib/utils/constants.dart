...
import 'package:ovlotracker/pages/settings_page/_pages/data_export_page.dart';
import 'package:ovlotracker/pages/settings_page/_pages/data_privacy_page.dart';
...
class AppConstants {
  ...
  static List<SettingsItem> privacyAndSecuritySettings = [
    SettingsItem(
      ...
      () => navigatorKey.currentState?.push(MaterialPageRoute(builder: (_) => DataPrivacyPage())),
    ),
    // SettingsItem(
