...
class _DayNavigatorState extends State<DayNavigator> {
  ...
  Widget build(BuildContext context) {
    var cycle = getValueForDateInMap(_focusedDay, PeriodSession().cycleNumbers)?["cycleDay"] == -1 ? "" : "Cycle Day ${getValueForDateInMap(_focusedDay, PeriodSession().cycleNumbers)?["cycleDay"]}";
    return Row(
